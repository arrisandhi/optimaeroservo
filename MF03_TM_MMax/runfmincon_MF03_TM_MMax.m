function [history,searchdir] = runfmincon_MF03_TM_MMax(maxMomOri,BeamProp,BeamDef,BeamSeg,AeDef,GustDef,SimDef,Nmodes,RVnum,X0,BaseRA)
...
Fun = @(X)main_optimCost_MF03_TM_MMax(X,BeamDef,BaseRA);
NLConstraintFun = @(X)confun_MF03_TM_MMax(X,BeamProp,BeamDef,BeamSeg,AeDef,GustDef,SimDef,Nmodes,RVnum,maxMomOri);
