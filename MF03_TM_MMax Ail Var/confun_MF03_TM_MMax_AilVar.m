function [cnlin, cnleq] = confun_MF03_TM_MMax_AilVar(X0,BeamProp,BeamDef,BeamSeg,AeDef,GustDef,SimDef,Nmodes,RVnum,maxMomOri)
aRA = X0(1);
bRA = X0(2);
cRA = X0(3);
NodeL = BeamDef.NodeL;
...
% Change flap location
AeDef.flapdistr(1,1:21) = 0;
AeDef.flapdistr(1,13:17) = 1;  
