function [history,searchdir] = runfmincon_MF03_TM_MMax_AilVar(maxMomOri,BeamProp,BeamDef,BeamSeg,AeDef,GustDef,SimDef,Nmodes,RVnum,X0,BaseRA)
...
Fun = @(X)main_optimCost_MF03_TM_MMax_AilVar(X,BeamDef,BaseRA);
NLConstraintFun = @(X)confun_MF03_TM_MMax_AilVar(X,BeamProp,BeamDef,BeamSeg,AeDef,GustDef,SimDef,Nmodes,RVnum,maxMomOri);
